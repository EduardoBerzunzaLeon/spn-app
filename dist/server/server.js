import { a as requestHandler, i as getResponse } from "./assets/server-TExfUSdF.js";
import "react";
import { RouterProvider } from "@tanstack/react-router";
import { jsx } from "react/jsx-runtime";
import { defineHandlerCallback, renderRouterToStream } from "@tanstack/react-router/ssr/server";
import { AsyncLocalStorage } from "node:async_hooks";
import { createRawStreamRPCPlugin, createSerializationAdapter, defaultSerovalPlugins, executeRewriteInput, invariant, isNotFound, isRedirect as isRedirect$1, isResolvedRedirect, makeSerovalPlugin, parseRedirect, resolveManifestAssetLink, rootRouteId as rootRouteId$1 } from "@tanstack/router-core";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-DJ2ruEjo.js");
...
var manifest = {
	"3a8b046a6b17237c61fe51b6b1b4dce61a449372089e3643605340d29c18d370": {
		functionName: "getLogs_createServerFn_handler",
		importer: () => import("./assets/refund.function-D0dvH9ie.js")
	},
	"bb40340065fda55edc82e4ac76875189a8789a2af5fad102d8f7fc851a57cc37": {
		functionName: "updateNotes_createServerFn_handler",
		importer: () => import("./assets/refund.function-D0dvH9ie.js")
	},
	"053d4dc288a73d579e943aa393aafd874b31093f1ef6fbf9fc37b71d6dd9c3b8": {
		functionName: "generateConsecutive_createServerFn_handler",
		importer: () => import("./assets/refund.function-D0dvH9ie.js")
	},
	"843602d617c198d99329114f6ac1f0f1511860d8a22c3c7e3370bf592f646853": {
		functionName: "getLastConsecutive_createServerFn_handler",
		importer: () => import("./assets/refund.function-D0dvH9ie.js")
	},
	"f8d535519569a9ec7e735097c04696d584ca02e691ed365605a4d5bff35ed27f": {
		functionName: "signIn_createServerFn_handler",
		importer: () => import("./assets/auth.function-aWtTaYLz.js")
	},
	"13639b2760296bf3dd7de71d0465dda1b8461d6f69bfc3603c3d2f023b6976f3": {
		functionName: "signOut_createServerFn_handler",
		importer: () => import("./assets/auth.function-aWtTaYLz.js")
	},
	"c56c5704cde910a8eb2d26e6ec0eb1ce447b3ff496628b3eeffec54ce975098b": {
		functionName: "getUser_createServerFn_handler",
		importer: () => import("./assets/auth.function-aWtTaYLz.js")
	},
	"32e51a59ba45284eb7fdc7555efdd3b3374df962c64243cf7337da84efcc32db": {
		functionName: "getFortnight_createServerFn_handler",
		importer: () => import("./assets/controlProcess.function-DqlkdnTz.js")
	},
	"3b2f808cb31c33735e405f573415b14880af48069869fd42ec188b606ef5aebf": {
		functionName: "getFortnight_createServerFn_handler",
		importer: () => import("./assets/controlSicon.function-DIlO_v8S.js")
	}
};
...
async function transformManifestAssets(source, transformFn, _opts) {
	...
	const rootRoute = manifest.routes[rootRouteId$1];
	if (rootRoute) {
		rootRoute.assets = rootRoute.assets || [];
...
function buildManifestWithClientEntry(source) {
	...
	const baseRootRoute = source.manifest.routes[rootRouteId$1];
	return { routes: {
		...source.manifest.routes,
		...baseRootRoute ? { [rootRouteId$1]: {
			...baseRootRoute,
...
async function loadEntries() {
	const routerEntry = await import("./assets/router-DRO6N8d6.js");
	return {
		startEntry: await import("./assets/start-BQC3RRT-.js"),
		routerEntry
	};
}
function getEntries() {
